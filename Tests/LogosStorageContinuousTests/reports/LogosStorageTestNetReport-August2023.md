...
1. Component initialization order - A timing issue in the initialization order of the several Logos Storage components caused nodes to improperly announce their addresses over the network in case the marketplace support was enabled.
