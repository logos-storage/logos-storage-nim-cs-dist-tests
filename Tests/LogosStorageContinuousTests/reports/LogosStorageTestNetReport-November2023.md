...
Continuous test runs (which can take many hours or days) can easily be started by team member from the github actions UI. Results are collected and displayed in Grafana. For the time being, we're suspending the effort to have a network of Logos Storage nodes "always online" and continuously being tested, until overal reliability improves.
