# Logos Storage Continuous Test-net Report
Date: 05-10-2023
...
Kubernetes namespace: 'storage-continuous-tests'
...
1. Cloud logging infrastructure was upgraded to reliably and verifiably retrieve Logos Storage container logs.
1. Test runners and tools were upgraded to support automated deploy and run from CI environment.
1. Test runners and tools were upgraded to support to automatic building and use of custom locally-built docker images of Logos Storage. (This allows to use of local modifications for quick debugging without the need to go through commit/review/CI workflow.)
