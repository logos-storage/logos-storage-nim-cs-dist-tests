...
//            NodeRunner.RunNode((logosStorageAccess, marketplaceAccess) =>
//            {
//                cid = UploadFile(logosStorageAccess.Node, file);
...
//                WaitForContractToStart(logosStorageAccess, purchaseId);
//            });
//        }
...
//            NodeRunner.RunNode((logosStorageAccess, marketplaceAccess) =>
//            {
//                var result = DownloadFile(logosStorageAccess.Node, cid!);
