...
//        public void UploadTest(int megabytes, LogosStorageAccess uploadNode)
//        {
...
//        public void DownloadTest(int megabytes, LogosStorageAccess uploadNode, LogosStorageAccess downloadNode)
//        {
//            var file = FileManager.GenerateTestFile(megabytes.MB());
...
//            Assert.That(timePerMB, Is.LessThan(LogosStorageContainerRecipe.MaxDownloadTimePerMegabyte), "MaxDownloadTimePerMegabyte performance threshold breached.");
//        }
